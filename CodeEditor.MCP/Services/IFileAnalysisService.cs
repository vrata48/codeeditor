...
Task<string> SearchFilesWithContextAsync(string text, string path = ".", int contextLines = 3, string filePattern = "*", int maxResults = 20);     Task<string> GetMethodSignaturesAsync(string path, string? className = null, bool includeProperties = true);
